<template>
  <div class="home">
          ...
          <v-row align="center" justify="center" class="white--text">
            <v-col cols="12">
              <div style="position: relative">
                <br />
                <br />
                <div class="text-center text-uppercase" id="mission">
                  <h1
                    style="
                      font-size: xxx-large;
    ...
    <v-container class="my-5">
      <v-layout wrap my-5>
        <v-flex xs12>
          <div class="heading font-weight-bold" id="mission">Our Mission</div>
        </v-flex>
        <v-flex xs12 mt-5>
      ...
      <v-layout wrap my-5>
        <v-flex xs12>
          <div class="heading font-weight-bold" id="goal">Our Goal</div>
        </v-flex>
        <v-flex xs12 mt-5>
          <div class="body-1">{{ goalText }}</div>
        </v-flex>
      </v-layout>
      <v-layout wrap my-5>
        <v-flex xs12>
        ...
        <iframe class ="my-3" width="100%" height="100%" src="https://www.youtube.com/embed/1k9O1XfpKt4" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
        </v-flex>
      </v-layout>
      ...
      <v-layout wrap my-5>
        ...
        <v-flex xs12 class="mt-2 mx-8">
          ...
          <br />
          <br />
          <myCard2 :story="stories[0]" />
          <br />
          <br />
          <myCard :story="stories[2]" />
          <br />
          <br />
        </v-flex>
      </v-layout>
